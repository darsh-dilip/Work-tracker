  ...
  return (
    <div style={{ minHeight:'100vh',background:'var(--bg)',display:'flex',alignItems:'center',justifyContent:'center' }}>
      <div className="fade-up" style={{ width:'100%',maxWidth:400,padding:20 }}>
        ...
        <div className="card" style={{ padding:28 }}>
          ...
          <div style={{ display:'flex',flexDirection:'column',gap:14 }}>
            <div>
              ...
              <input type="email" placeholder="you@yourfirm.com" value={email} onChange={e=>setEmail(e.target.value)} onKeyDown={e=>e.key==='Enter'&&submit()} autoFocus/>
            </div>
            <div>
        ...
        <div style={{ textAlign:'center',marginTop:16,fontSize:12,color:'var(--text3)' }}>New team members: ask your Partner/Admin to create your account.</div>
      </div>
    </div>
  )
}
