      ...
      <div className="fade-up" style={{ width: '100%', maxWidth: 400, padding: 20 }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <div style={{ fontSize: 13, color: 'var(--text2)', marginTop: 6 }}>
            CA Firm Task &amp; Compliance Manager
          </div>
        </div>
        ...
        <div className="card" style={{ padding: 28 }}>
          ...
          {/* Using a div instead of form to avoid HTML form issues */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div>
              <div style={{ fontSize: 12, color: 'var(--text2)', marginBottom: 6, fontWeight: 600 }}>Email</div>
              <input
                type="email" placeholder="you@yourfirm.com"
        ...
        <div style={{ textAlign: 'center', marginTop: 16, fontSize: 12, color: 'var(--text3)' }}>
          New team members: ask your Partner/Admin to create your account.
        </div>
      </div>
    </div>
  )
