...
const NAV = [
  ...
  { id:'it',        icon:'📋', label:'IT & Accounts',  mgr:true },
  { sep:true, mgr:true },
...
export const Sidebar = ({ page, setPage, user, onLogout, overdueCount=0 }) => {
  ...
  return (
    <div style={{ width:210,flexShrink:0,background:'var(--surface)',borderRight:'1px solid var(--border)',display:'flex',flexDirection:'column',height:'100vh',position:'sticky',top:0 }}>
